...
class BaseService extends Egg.Service {
 ...
 //  * @param {string} [options.deferrable]   可选，设置立即或延迟检查约束 （貌似仅用于 postgresql）
   ...
   * @param {Egg.Search[]}  [options.search]        -  可选，关键字搜索.  [{key:'string',fields:[string|{[prefix,]field,type,mode}|[string|{[prefix,]field,type,mode}]}]]
   ...
   * @param {Object} query
   * @param {Object} options
   * @param {Egg.Search[]}  options.search  -  关键字搜索.  [{key:'string',fields:[string|{[prefix,]field,type,mode}|[string|{[prefix,]field,type,mode}]}]]
   * @returns {Object}
   * @memberof BaseService
   */
